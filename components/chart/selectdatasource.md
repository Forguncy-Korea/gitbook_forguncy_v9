...
1. 셀 범위를 데이터 원본으로 선택하고 리본 메뉴 모음에서 \[삽입]을 선택합니다.
...
4. **데이터 원본을 선택합니다.** 리본 메뉴 모음에서 \[차트 도구->디자인-> 데이터 선택]을 선택하거나 차트에서 마우스 오른쪽 버튼을 클릭하고 팝업 메뉴에서 데이터 선택을 선택하여 차트에 표시된 데이터를 추가로 변경하고 재정렬합니다.
