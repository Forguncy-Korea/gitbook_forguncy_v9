...
2. &#x20;커서가 등호 뒤에 있으면 셀을 선택하거나 다른 셀을 직접 입력합니다. 아래 그림에서 E4 셀을 선택하거나 "E4"를 직접 입력합니다.

![](../../.gitbook/assets/fx2.png)

3. 입력 연산자(예: 더하)를 입력합니다.
4. &#x20;다음 셀을 선택하거나 다른 셀을 직접 입력합니다. 아래 그림에서 E4 셀을 선택하거나 "E4"를 직접 입력합니다.
5. &#x20;Enter 키를 눌러 수식 작성을 완료합니다. 페이지가 실행되면 계산 결과가 페이지에 표시됩니다.
