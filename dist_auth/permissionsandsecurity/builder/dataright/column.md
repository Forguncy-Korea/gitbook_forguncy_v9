...
3. &#x20;행 조건 필터를 설정하면 조건을 충족하는 레코드가 필터링되어 인증된 사용자가 해당 작업을 수행할 수 있습니다.조건 필터 열을 클릭하여 조건을 설정합니다. 팝업 조건 필터 대화 상자에서 조건을 설정합니다. 예를 들어 아래 그림과 같이 두 번째 권한 제어의 조건을 "구매자는 로그인 사용자입니다"로 설정합니다.
