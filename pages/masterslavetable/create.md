...
4. &#x20;마스터 리스트가 설정되면 마스터 테이블에 하위테이블이 나타납니다. 테이블에서 연결 필드를 확장하기 전에 기본 테이블에 대한 정보가 나타납니다.\
   종속 테이블인 주문 상세 정보 테이블을 두 번 클릭하면 테이블이 열립니다.
...
5. &#x20;마스터 리스트가 설정되면 마스터 테이블에 하위 테이블이 나타납니다. 테이블에서 연결 필드를 확장하기 전에 기본 테이블에 대한 정보가 나타납니다.\
