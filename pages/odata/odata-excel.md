...
1. 페이지에 테이블을 만들어 데이터를 표시합니다.&#x20;
2. &#x20;총 금액을 표시할 셀을 선택하고 리본 메뉴 모음에서 \[수식->OData 생성기]를 선택합니다.
3. &#x20;OData 생성기에서 테이블을  제품으로 선택하고 선택 탭에서 열을 선택하고 금액을 선택합니다.

![](../../.gitbook/assets/bb.png)

4. &#x20;\[쿼리] 탭에서 \[새 조건]을 클릭하고 \[필드]를 \[범주], \[연산자]를 \[같음], \[값]을 \[과자]로 설정합니다.

![](../../.gitbook/assets/cc.png)

5. \[확인]을 클릭한 후 Enter 키를 눌러 OData 수식을 커밋합니다.
6. &#x20;다음 그림과 같이 OData 수식이 있는 셀을 두 번 클릭하여 편집 모드로 전환하고 OData 수식 앞에 SUM 함수를 추가하고 OData 수식을 괄호로 묶습니다.

![](../../.gitbook/assets/Odata_sum.png)

7. 페이지를 실행한 후 브라우저에서 배열 수식에 따라 계산된 과자의 총 금액을 볼 수 있습니다.
