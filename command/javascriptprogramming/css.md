...
2. &#x20;CSS 파일을 새로 만들거나 업로드합니다. \[파일-> 설정-> 사용자 정의 JavaScript/CSS를 선택하고 \[CSS 파일 업로드] 영역에서 \[링크 추가], \[파일 추가] 또는 \[새 파일]을 선택합니다.그림과 같이 css 코드와 함께 스타일 .css 파일을 업로드합니다. 여기서 myCell은 클래스 이름입니다.
