...
2. &#x20;개체 관리자에서서버 명령 탭을 마우스 오른쪽 버튼으로 클릭하고 "서버 명령 생성"을 선택하면 서버 명령 편집 대화 상자가 나타나 서버 명령의 일반 설정을 편집할 수 있습니다. 서버 명령의 이름을 "저장 프로시저 호출"로 설정합니다.





3. 매개변수를 편집합니다. 다음 두 매개변수를 추가합니다.
